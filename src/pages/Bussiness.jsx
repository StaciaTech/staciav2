...
//                             <div key={index} className="role-pill" onClick={() => handleRoleClick(role)}>
...
//                         {selectedRole && selectedRole.description.map((point, idx) => (
//                             <li key={idx}>{point}</li>
//                         ))}
//                     </ul> */}
//                     <p>{selectedRole && selectedRole.description}</p>
//                 </div>
//             </div>
//         </div>
//     );
...
//                 <h1>How to Start a Business</h1>
//                 <h2>
//                     in {steps.length} Easy Steps for {selectedDepartment.name}
//                 </h2>
//                 <div className="steps">
//                     {steps.map((step, index) => {
//                         const IconComponent = iconMap[step.icon];
...
//                                 {selectedDepartment.roles.length}
//                             </span>
//                         </div>
//                     </div>
