...
// Both up and downward working but 4th dot not working
...
//           let minTop = currentEntry.target.getBoundingClientRect().top;

//           // Look for a section closer to the viewport top
//           entries.forEach((entry) => {
...
//           }
//         } else {
//           // Current section is not intersecting, find the topmost intersecting section
//           let bestIndex = activeIndex;
//           let minTop = Infinity;
...
//       {
//         root: null,
//         threshold: [0.5, 0.3], // Trigger at 10% and 30% visibility
//       }
//     );
