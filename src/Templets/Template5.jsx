...
//                   {typeof obj === "string"
//                     ? obj
//                     : obj.des || "No objective description"}
//                 </li>
//               ))
//             ) : (
//               <p className="para-temp-styles temp-margin">
//                 {project["Project-Objective"] ||
//                   "No project objective available"}
//               </p>
//             )}
...
//                 <ul className="sol">
//                   {Array.isArray(project.Stage) && project.Stage.length > 0 ? (
//                     project.Stage.slice(
//                       0,
//                       Math.ceil(project.Stage.length / 2)
//                     ).map((stage, index) => (
//                       <div key={index}>
...
//                             <div className="sol">
//                               <li className="para-temp-styles temp-margin">
//                                 {project.Gate[index === 0 ? 0 : 2]?.Line1 ||
//                                   "No gate decision"}
//                               </li>
//                             </div>
//                           </div>
...
//                         Math.ceil(project.Stage.length / 2)
//                       ).map((stage, index) => (
//                         <div key={index + Math.ceil(project.Stage.length / 2)}>
//                           <p className="temp5-sec4-title">
//                             {stage.name || "Unnamed Stage"}
//                           </p>
//                           <div className="sol">
...
//                               <div className="sol">
//                                 <li className="para-temp-styles temp-margin">
//                                   {project.Gate[index === 0 ? 1 : 3]?.Line1 ||
//                                     "No gate decision"}
//                                 </li>
//                               </div>
//                             </div>
...
//             )}
//             {project.Solutions2 &&
//               Array.isArray(project.Solutions2) &&
...
//               Array.isArray(project["Technical-Implementation"]) && (
//                 <div>
//                   <p className="temp5-sec4-subheading">
